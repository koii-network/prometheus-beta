...
def test_max_consecutive_char_sum_multiple_sequences():
    assert max_consecutive_char_sum('abcmnpqr') == 297  # a(97) + b(98) + c(99) = 294, later seq = 297
    assert max_consecutive_char_sum('abcxyzpqr') == 297  # p(112) + q(113) + r(114) = 339
...
def test_max_consecutive_char_sum_edge_cases():
    ...
    assert max_consecutive_char_sum('acbde') == 101  # single d(100) or e(101)
