...
def find_mode(numbers: List[float]) -> Union[float, List[float]]:
    ...
    Returns:
        ...
        If all elements are unique, returns a list of all elements.
    ...
    # Return single mode if repeated, else return all elements
    return modes[0] if len(modes) == 1 and max_freq > 1 else modes