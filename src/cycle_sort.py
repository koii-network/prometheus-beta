def cycle_sort(arr):
    ...
    Cycle sort is an in-place, unstable sorting algorithm that is optimal 
    in terms of the number of memory writes. It is particularly useful when 
    writing to memory is a costly operation.
