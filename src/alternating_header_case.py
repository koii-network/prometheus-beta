def to_alternating_header_case(input_string: str) -> str:
    ...
    where words alternate between capitalized and a specific alternating case pattern.
    ...
    for i, word in enumerate(words):
        if i % 2 == 0:
            ...
            # Odd index words follow a specific case pattern
            converted_word = word[0].lower() + ''.join(
