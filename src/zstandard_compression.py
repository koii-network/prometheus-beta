...
def compress_file(input_path: str, output_path: Optional[str] = None, compression_level: int = 3) -> str:
    """
    ...
    Args:
        ...
        output_path (str, optional): Path to save the compressed file. 
            If not provided, appends '.zst' to the input path.
        compression_level (int, optional): Compression level (1-22). 
            Defaults to 3. Higher levels provide better compression but are slower.
...
def decompress_file(input_path: str, output_path: Optional[str] = None) -> str:
    ...
    Args:
        ...
        output_path (str, optional): Path to save the decompressed file. 
            If not provided, removes '.zst' extension from input path.
    ...
    # Validate input file has .zst extension
