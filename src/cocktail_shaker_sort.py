def cocktail_shaker_sort(arr):
    """
    Implement the cocktail shaker sort algorithm.
    
    This algorithm is a variation of bubble sort that sorts in both directions.
    It works by doing a bubble sort pass from left to right, then from right to left,
