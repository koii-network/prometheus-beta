def determine_football_match_winner(team1_players, team2_players, team1_goals, team2_goals):
    ...
    Returns:
    str: Winner of the match or 'Draw' based on specific conditions
    
    Conditions:
    1. If a team has scored more goals, they win
    2. If goals are equal, but one team has fewer players, that team wins
    3. If all conditions are equal, it's a draw
    """
    ...
    # Goal difference determines winner
    if team1_goals > team2_goals:
        return "Team 1 Wins"
    elif team2_goals > team1_goals:
        return "Team 2 Wins"
    
    # If goals are equal, fewer players team wins
